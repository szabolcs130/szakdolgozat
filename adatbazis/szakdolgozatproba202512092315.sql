...
(14, 'alma', 100, 'Magyar termek.Magyar termek.Magyar termek.Magyar termek.Magyar termek.Magyar termek.Magyar termek.Magyar termek.Magyar termek.Magyar termek.Magyar termek.Magyar termek.Magyar termek.Magyar termek.Magyar termek.Magyar termek.Magyar termek.Magyar termek.Mag', 89, 'alma'),
(15, 'korte', 200, 'leiras', 189, 'korte'),
(17, 'eper', 300, 'leiras', 300, 'eper'),
...
(86, 55, '2025-11-05 15:23:37'),
(87, 55, '2025-11-06 16:25:04'),
(88, 55, '2025-11-07 19:24:14'),
(89, 55, '2025-11-08 19:24:14'),
(90, 55, '2025-12-01 19:24:14'),
(91, 55, '2025-12-02 19:24:14'),
(92, 55, '2025-12-03 19:24:14'),
(93, 55, '2025-12-04 19:24:14'),
(94, 55, '2025-12-05 19:24:14'),
(95, 55, '2025-12-08 19:26:58'),
(96, 55, '2025-12-08 19:26:59'),
(97, 55, '2025-12-08 10:19:09');
...
(20, 55, 1111, 'Alma varos', 'Korte utca', '1', 1, '1');
...
--
ALTER TABLE `fizeteseredmeny`
  MODIFY `id_fizetes` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=64;
...
--
ALTER TABLE `rendeles`
  MODIFY `id_rendeles` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=98;

--
-- AUTO_INCREMENT for table `rendelestartalma`
--
ALTER TABLE `rendelestartalma`
  MODIFY `id_rendelestartalma` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=112;

--
-- AUTO_INCREMENT for table `szallitasicim`
--
ALTER TABLE `szallitasicim`
  MODIFY `id_szallitasicim` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT for table `szemely`
--
ALTER TABLE `szemely`
  MODIFY `id_szemely` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=68;
