...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 31, 2025 at 03:34 PM
...
CREATE TABLE `fizeteseredmeny` (
  ...
  `id_kulsofizetes` int(255) NOT NULL,
...
INSERT INTO `fizeteseredmeny` (`id_fizetes`, `idf_rendeles`, `datum`, `osszeg`, `id_kulsofizetes`, `allapot`) VALUES
(2, 1, '2025-10-31', 100, 100, 'ok');
...
--
ALTER TABLE `fizeteseredmeny`
  MODIFY `id_fizetes` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `rendeles`
  MODIFY `id_rendeles` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `rendelestartalma`
--
ALTER TABLE `rendelestartalma`
  MODIFY `id_rendelestartalma` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
